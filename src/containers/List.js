      ...
      return (
        <div className='list-container'>
          ...
          <div className='ui container'>
            <button name='i=chicken%20breast' onClick={this.filterOnClick}>Chicken</button>
            <button name='c=Seafood' onClick={this.filterOnClick}>Seafood</button>
            <button name='a=Canadian' onClick={this.filterOnClick}>Canadian</button>
          </div>
          ...
          <ul className='ui four column doubling grid container'>
            {items && items.map(item => (
              <ListItem image={item.strMealThumb}
                        title={item.strMeal}
                        key={item.idMeal}
